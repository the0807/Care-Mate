...
def socket():
    os.system("python3 /home/ros/waypoint/socket/server.py")
...
class MultiNav():
    def __init__(self):
        ...
        locations['point-1'] = Pose(Point(2.0, 0.0, 0), Quaternion(0.000, 0.000, 0.000, 1.000))
        locations['point-2'] = Pose(Point(0, 0, 0), Quaternion(0.000, 0.000, 0.000, 1.000))
        ...
        for location in locations.keys():
            ...
            socket_process = mp.Process(target=socket, name="p3")
